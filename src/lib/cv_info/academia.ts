...
export const teaching_roles: AcademicRole[] = [
    {
        year: '2024 Spring', 
        title: 'Applied Cryptography', 
        bullets: [
            'Held weekly office hours for students to ask questions about the following course topics: homomorphic properties of various asymmetric schemes, oblivious transfer, garbled circuits, threshold encryption, blind signatures, elementary zero-knowledge proofs, digital signatures, block ciphers, Diffie-Hellman ratchet, modes of symmetric encryption, message integrity, asymmetric encryption, and key derivation.', 
        ] 
    },
    { 
        year: '2023 Spring', 
        ...
        bullets: [
            'Held weekly office hours for students to ask about the following course topics: theoretical foundations of digital signature schemes, public key infrastructure, and differential privacy.'
        ] 
    },
    { 
        year: '2021 Fall', 
        ...
        bullets: [
            ...
            'Held weekly office hours for students to ask about the following course topics: convolutional NNs, recurrent NNs (LSTM, GRU), autoencoders, transformers, graph NNs, and generative adversarial NNs, mathematical foundations of deep learning, PyTorch, and TensorFlow',
        ] 
    },
    { 
        year: '2021 Summer', 
        ...
        bullets: [
            ...
            'Designed and implemented an extensive peer-to-peer blockchain codebase in GoLang from the ground up. This included developing a consensus mechanism, fork-choice rules, cryptocurrency functionalities, wallets, transaction memory pools, and thorough logging systems. Students added to this codebase in their assignments.',
            'Designed and implemented a more optimized version of state management and consensus in C++.',
    ...
    { 
        ...
        bullets: [
            'Held weekly office hours for students to ask about the following course topics: HTML, CSS, Javascript, Typescript, React, React Native, Vue, NextJS, Tailwind, Bootstrap, NodeJS, Express,Firebase, MongoDB, Django, Flask, front-end state management, object relational mapping, and authentication.'
        ] 
    }
];
